...
export const en = {
  'error.too_many_devices': 'Too many devices are registered. Remove an unused device first.',
  'sote.conflict': 'This task has changed. Compare the current values below with your draft before saving.',
  'sote.unplanned': 'Not planned',
  'sote.reviewed': 'Reviewed — keep my draft',
  'slash.sote-list': 'SOTE task list',
  'slash.sote-list.hint': 'Show and edit a SOTE project',
  'slash.sote-list.keywords': 'sote,tasks,project',
  'slash.sote-single': 'SOTE task',
  ...
  "sote.account": "Your SOTE account",
  "sote.connected": "Connected",
  "sote.notConnected": "Not connected",
  "sote.until": "Access until",
  "sote.connect": "Connect SOTE account",
  "sote.renew": "Renew access / change projects",
  "sote.disconnect": "Disconnect account",
  "sote.setupRequired": "The administration needs to register SOTE first.",
  "sote.projects": "Projects in this workspace",
  "sote.projectsHint": "Choose projects for embedded task lists. This does not grant anyone additional rights.",
  "sote.save": "Save",
  "sote.server": "SOTE instance",
  "sote.disconnectServerHint": "This removes all local account connections and project mappings. Also revoke this SONE instance in SOTE to invalidate its access tokens.",
  "sote.disconnectServer": "Remove instance connection",
  "sote.setupHint": "Register this SONE address in SOTE under Settings → Connected applications. Enter the returned client ID and secret here.",
  "sote.address": "SOTE address",
  "sote.secret": "Client secret",
  "sote.title": "Title",
  "sote.planned": "Planned",
  "sote.duration": "Duration (minutes)",
  "sote.allDay": "All day",
  "sote.note": "Description",
  "sote.create": "Create task",
  "sote.settings": "Connections",
  "sote.refresh": "Refresh tasks",
  "sote.chooseProject": "Choose a project approved for this workspace.",
  "sote.project": "Project",
  "sote.task": "Task",
  ...
  "sote.edit": "Edit",
  "sote.empty": "No tasks yet.",
  "sote.more": "Load more",
  "sote.retryHint": "The last request has not been confirmed. Saving again retries the same task with the original input.",
  "sote.notConfigured": "This task block has not been configured.",
  "sote.failed": "SOTE is currently unavailable.",
  "sote.loginFailed": "The connection could not be completed. Start again to sign in to SOTE.",
  "sote.invalidDate": "Please choose a valid local date and time.",
  "sote.list": "SOTE task list",
  "sote.listHint": "Show and edit a SOTE project",
  "sote.single": "SOTE task",
  "sote.singleHint": "Link or create one task",
  ...
  'workspace.export.remove': 'Remove',
  ...
  'format.linkOpen': 'Open',
  'format.linkCopy': 'Copy address',
  'format.linkCopied': 'Copied',
  'format.linkEdit': 'Change',
  ...
  'block.colour': 'Colour',
  'block.tone': 'Kind of callout',
  'block.tone.note': 'Note',
  'block.tone.info': 'Info',
  'block.tone.tip': 'Tip',
  'block.tone.warning': 'Warning',
  'block.tone.error': 'Error',
  'block.tone.alarm': 'Alarm',
  'block.tone.exclaim': 'Exclamation',
  'block.tone.question': 'Question',
  'block.tone.success': 'Success',
  'block.tone.memo': 'Memo',
  'block.tone.example': 'Example',
  'block.tone.quote': 'Quotation',
  'block.source': 'Source',
  'block.source.placeholder': 'Who said it',
  'block.rule': 'Line',
  'block.rule.solid': 'Solid',
  'block.rule.dashed': 'Dashed',
  'block.rule.dotted': 'Dotted',
  'block.rule.double': 'Double',
  'block.rule.thick': 'Thick',
  'block.rule.fade': 'Fade',
  'block.rule.short': 'Short',
  'block.rule.wave': 'Wave',
  'block.rule.bars': 'Bars',
  'block.ornament': 'Symbol',
  'block.ornament.none': 'No symbol',
  'block.ornament.dot': 'Dot',
  'block.ornament.diamond': 'Diamond',
  'block.ornament.ellipsis': 'Three dots',
  'block.ornament.asterism': 'Asterism',
  'block.ornament.circle': 'Circle',
  'block.ornament.square': 'Square',
  'block.ornament.leaf': 'Leaf',
  'block.ornament.star': 'Star',
  'block.ornament.sun': 'Sun',
  'block.ornament.moon': 'Moon',
  'block.ornament.wave': 'Wave',
  'block.ornament.flower': 'Flower',
  'block.ornament.heart': 'Heart',
  'block.ornament.coffee': 'Coffee',
  'block.ornament.anchor': 'Anchor',
  'block.ornament.quill': 'Quill',
  'block.ornament.scissors': 'Scissors',
  'block.ornament.arrow': 'Arrow',
  'block.ornament.note': 'Note',
  'block.ornament.info': 'Info',
  'block.ornament.tip': 'Tip',
  'block.ornament.warning': 'Warning',
  'block.ornament.error': 'Error',
  'block.ornament.alarm': 'Alarm',
  'block.ornament.exclaim': 'Exclamation',
  'block.ornament.question': 'Question',
  'block.ornament.success': 'Success',
  'block.ornament.memo': 'Memo',
  'block.ornament.example': 'Example',
  'block.ornament.quote': 'Quotation',
  'block.ornamentAt': 'Position',
  'block.ornamentAt.start': 'Start',
  'block.ornamentAt.center': 'Centre',
  'block.ornamentAt.end': 'End',
  ...
  'slash.callout-info.hint': 'Something worth knowing',
  'slash.callout-info.keywords': '',
  'slash.callout-tip': 'Tip',
  'slash.callout-tip.hint': 'A better way to do it',
  'slash.callout-tip.keywords': '',
  'slash.callout-warning': 'Warning',
  'slash.callout-warning.hint': 'Something that can go wrong',
  'slash.callout-warning.keywords': '',
  'slash.callout-error': 'Error',
  'slash.callout-error.hint': 'Something that has gone wrong',
  'slash.callout-error.keywords': '',
  'slash.callout-alarm': 'Alarm',
  'slash.callout-alarm.hint': 'Needs attention now',
  'slash.callout-alarm.keywords': '',
  'slash.callout-exclaim': 'Exclamation',
  'slash.callout-exclaim.hint': 'Not to be missed',
  'slash.callout-exclaim.keywords': '',
  'slash.callout-question': 'Question',
  'slash.callout-question.hint': 'Open, to be answered',
  'slash.callout-question.keywords': '',
  'slash.callout-success': 'Success',
  'slash.callout-success.hint': 'Done, or went well',
  'slash.callout-success.keywords': '',
  'slash.callout-memo': 'Memo',
  'slash.callout-memo.hint': 'A note in the margin',
  'slash.callout-memo.keywords': '',
  'slash.callout-example': 'Example',
  'slash.callout-example.hint': 'Shows how it looks in practice',
  'slash.callout-example.keywords': '',
  'slash.callout-quote': 'Quotation box',
  'slash.callout-quote.hint': 'A quotation as a box',
  'slash.callout-quote.keywords': '',
  'slash.code': 'Code',
  ...
  'error.job_running': 'The archive is still being packed and can be removed once it is done.',
