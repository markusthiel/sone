...
export const de: Record<keyof typeof en, string> = {
  'error.too_many_devices': 'Zu viele Geräte sind registriert. Bitte zuerst ein ungenutztes Gerät entfernen.',
  'sote.conflict': 'Diese Aufgabe wurde geändert. Vor dem Speichern bitte den aktuellen Stand unten mit dem Entwurf vergleichen.',
  'sote.unplanned': 'Nicht geplant',
  'sote.reviewed': 'Geprüft – meinen Entwurf beibehalten',
  'slash.sote-list': 'SOTE-Aufgabenliste',
  'slash.sote-list.hint': 'Ein SOTE-Projekt anzeigen und bearbeiten',
  'slash.sote-list.keywords': 'sote,aufgaben,projekt',
  'slash.sote-single': 'SOTE-Aufgabe',
  ...
  "sote.account": "Persönliches SOTE-Konto",
  "sote.connected": "Verbunden",
  "sote.notConnected": "Nicht verbunden",
  "sote.until": "Zugang bis",
  "sote.connect": "SOTE-Konto verbinden",
  "sote.renew": "Zugang erneuern / Projekte ändern",
  "sote.disconnect": "Konto trennen",
  "sote.setupRequired": "Die Administration muss SOTE zuerst einrichten.",
  "sote.projects": "Projekte in diesem Arbeitsbereich",
  "sote.projectsHint": "Wähle Projekte für eingebettete Aufgabenlisten. Dadurch erhält niemand zusätzliche Rechte.",
  "sote.save": "Speichern",
  "sote.server": "SOTE-Instanz",
  "sote.disconnectServerHint": "Das entfernt alle lokalen Kontoverbindungen und Projektzuordnungen. Widerrufe diese SONE-Instanz auch in SOTE, damit ihre Zugangstokens ungültig werden.",
  "sote.disconnectServer": "Instanzverbindung entfernen",
  "sote.setupHint": "Registriere diese SONE-Adresse in SOTE unter Einstellungen → Verbundene Anwendungen. Trage die erhaltene Client-ID und das Geheimnis hier ein.",
  "sote.address": "SOTE-Adresse",
  "sote.secret": "Client-Geheimnis",
  "sote.title": "Titel",
  "sote.planned": "Geplant",
  "sote.duration": "Dauer (Minuten)",
  "sote.allDay": "Ganztägig",
  "sote.note": "Beschreibung",
  "sote.create": "Aufgabe anlegen",
  "sote.settings": "Verbindungen",
  "sote.refresh": "Aufgaben aktualisieren",
  "sote.chooseProject": "Wähle ein für diesen Arbeitsbereich freigegebenes Projekt.",
  "sote.project": "Projekt",
  "sote.task": "Aufgabe",
  ...
  "sote.edit": "Bearbeiten",
  "sote.empty": "Noch keine Aufgaben.",
  "sote.more": "Weitere laden",
  "sote.retryHint": "Die letzte Anfrage wurde noch nicht bestätigt. Erneutes Speichern wiederholt dieselbe Aufgabe mit der ursprünglichen Eingabe.",
  "sote.notConfigured": "Dieser Aufgabenblock wurde noch nicht eingerichtet.",
  "sote.failed": "SOTE ist derzeit nicht verfügbar.",
  "sote.loginFailed": "Die Verbindung konnte nicht abgeschlossen werden. Starte die Anmeldung bei SOTE erneut.",
  "sote.invalidDate": "Bitte wähle ein gültiges örtliches Datum mit Uhrzeit.",
  "sote.list": "SOTE-Aufgabenliste",
  "sote.listHint": "Ein SOTE-Projekt anzeigen und bearbeiten",
  "sote.single": "SOTE-Aufgabe",
  "sote.singleHint": "Eine Aufgabe verknüpfen oder anlegen",
  ...
  'block.colour': 'Farbe',
  'block.tone': 'Art des Hinweises',
  'block.tone.note': 'Hinweis',
  'block.tone.info': 'Info',
  'block.tone.tip': 'Tipp',
  'block.tone.warning': 'Achtung',
  'block.tone.error': 'Fehler',
  'block.tone.alarm': 'Alarm',
  'block.tone.exclaim': 'Ausruf',
  'block.tone.question': 'Frage',
  'block.tone.success': 'Erfolg',
  'block.tone.memo': 'Notiz',
  'block.tone.example': 'Beispiel',
  'block.tone.quote': 'Zitat',
  'block.source': 'Quelle',
  'block.source.placeholder': 'Wer es gesagt hat',
  'block.rule': 'Linie',
  'block.rule.solid': 'Durchgezogen',
  'block.rule.dashed': 'Gestrichelt',
  'block.rule.dotted': 'Gepunktet',
  'block.rule.double': 'Doppelt',
  'block.rule.thick': 'Kräftig',
  'block.rule.fade': 'Verlauf',
  'block.rule.short': 'Kurz',
  'block.rule.wave': 'Welle',
  'block.rule.bars': 'Striche',
  'block.ornament': 'Symbol',
  'block.ornament.none': 'Kein Symbol',
  'block.ornament.dot': 'Punkt',
  'block.ornament.diamond': 'Raute',
  'block.ornament.ellipsis': 'Drei Punkte',
  'block.ornament.asterism': 'Asterismus',
  'block.ornament.circle': 'Kreis',
  'block.ornament.square': 'Quadrat',
  'block.ornament.leaf': 'Blatt',
  'block.ornament.star': 'Stern',
  'block.ornament.sun': 'Sonne',
  'block.ornament.moon': 'Mond',
  'block.ornament.wave': 'Welle',
  'block.ornament.flower': 'Blume',
  'block.ornament.heart': 'Herz',
  'block.ornament.coffee': 'Kaffee',
  'block.ornament.anchor': 'Anker',
  'block.ornament.quill': 'Federkiel',
  'block.ornament.scissors': 'Schere',
  'block.ornament.arrow': 'Pfeil',
  'block.ornament.note': 'Hinweis',
  'block.ornament.info': 'Info',
  'block.ornament.tip': 'Tipp',
  'block.ornament.warning': 'Achtung',
  'block.ornament.error': 'Fehler',
  'block.ornament.alarm': 'Alarm',
  'block.ornament.exclaim': 'Ausruf',
  'block.ornament.question': 'Frage',
  'block.ornament.success': 'Erfolg',
  'block.ornament.memo': 'Notiz',
  'block.ornament.example': 'Beispiel',
  'block.ornament.quote': 'Zitat',
  'block.ornamentAt': 'Position',
  'block.ornamentAt.start': 'Anfang',
  'block.ornamentAt.center': 'Mitte',
  'block.ornamentAt.end': 'Ende',
  ...
  'block.copyLink': 'Link zu diesem Block kopieren',
  'block.linkCopied': 'Link kopiert',
  ...
  'slash.callout-info': 'Info',
  'slash.callout-info.hint': 'Etwas, das man wissen sollte',
  'slash.callout-info.keywords': 'hinweis, info, information',
  'slash.callout-tip': 'Tipp',
  'slash.callout-tip.hint': 'Ein besserer Weg',
  'slash.callout-tip.keywords': 'hinweis, tipp, idee, rat',
  'slash.callout-warning': 'Achtung',
  'slash.callout-warning.hint': 'Etwas, das schiefgehen kann',
  'slash.callout-warning.keywords': 'hinweis, achtung, warnung, vorsicht',
  'slash.callout-error': 'Fehler',
  'slash.callout-error.hint': 'Etwas, das schiefgegangen ist',
  'slash.callout-error.keywords': 'hinweis, fehler, störung',
  'slash.callout-alarm': 'Alarm',
  'slash.callout-alarm.hint': 'Braucht jetzt Aufmerksamkeit',
  'slash.callout-alarm.keywords': 'hinweis, alarm, dringend, kritisch',
  'slash.callout-exclaim': 'Ausruf',
  'slash.callout-exclaim.hint': 'Nicht zu übersehen',
  'slash.callout-exclaim.keywords': 'hinweis, ausruf, wichtig',
  'slash.callout-question': 'Frage',
  'slash.callout-question.hint': 'Offen, noch zu klären',
  'slash.callout-question.keywords': 'hinweis, frage, offen, klären',
  'slash.callout-success': 'Erfolg',
  'slash.callout-success.hint': 'Erledigt oder gut gelaufen',
  'slash.callout-success.keywords': 'hinweis, erfolg, erledigt, haken',
  'slash.callout-memo': 'Notiz',
  'slash.callout-memo.hint': 'Eine Bemerkung am Rand',
  'slash.callout-memo.keywords': 'hinweis, notiz, bemerkung, anmerkung',
  'slash.callout-example': 'Beispiel',
  'slash.callout-example.hint': 'Zeigt, wie es in der Praxis aussieht',
  'slash.callout-example.keywords': 'hinweis, beispiel, muster',
  'slash.callout-quote': 'Zitatkasten',
  'slash.callout-quote.hint': 'Ein Zitat als Kasten',
  'slash.callout-quote.keywords': 'hinweis, zitat, spruch',
  'slash.code': 'Code',
  ...
  'panel.linkInternal': 'In diesem Arbeitsbereich',
  'panel.pointsHere': 'Verweist hierher',
  'panel.pointsHereSub': 'Verlinkt diese Seite',
